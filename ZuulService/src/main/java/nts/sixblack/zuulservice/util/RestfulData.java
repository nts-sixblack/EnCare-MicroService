...
import nts.sixblack.zuulservice.response.*;
...
public class RestfulData {
    ...
    public boolean existAccount(long doctorId) {
        try {
            ResponseEntity<ResponseObject> response = restTemplate.getForEntity("http://zuul-service/account/exist/"+doctorId, ResponseObject.class);
            return existData(response);
        } catch (Exception e) {
            return false;
        }
    ...
    public AccountResponse informationAccount(long accountId) {
        try {
            ResponseEntity<ResponseObject> response = restTemplate.getForEntity("http://zuul-service/account/information/"+accountId, ResponseObject.class);
            Gson gson = new Gson();
            JsonObject jsonObject = gson.toJsonTree(response.getBody().getData()).getAsJsonObject();
    ...
    public Object findDoctorByName(String name, int page) {
        try {
            ResponseEntity<ResponseObject> response = restTemplate.getForEntity("http://zuul-service/account/findDoctor?name="+name+"&page="+page, ResponseObject.class);
    ...
    public boolean existCategory(long doctorId) {
        try {
            ResponseEntity<ResponseObject> response = restTemplate.getForEntity("http://doctor/category/exist/"+doctorId, ResponseObject.class);
            return existData(response);
        } catch (Exception e) {
            return false;
        }
